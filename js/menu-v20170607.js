...
function WidthChange(mq) {
  ...
  if ( checkListen ) {
    // console.log('WidthChange. Er is een listener');
    if (mq.matches) {
      // window width is at least 900px
      // don't show menu button
      // console.log('menubreedtecheck: groter dan 900px');
      hideMenuButton(document, window);
    }
    else {
      // window width is less than 900px
      // DO show menu button
      // console.log('menubreedtecheck: kleiner dan 900px');
      showMenuButton(document, window);
    }
  }
  else {
    // console.log('WidthChange. Er is geen listener');
  }
}
...
if (matchMedia) {
  ...
  if ( mq.addListener ) {
    checkListen = true;
    // console.log('Menu. Er is een listener');
