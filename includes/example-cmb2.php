...
if ( 22 == 22 ) {
   ...
   */
  function rhswp_show_if_front_page( $cmb ) {
   ...
   * @return bool                     True if metabox should show
   */
  function rhswp_hide_if_no_cats( $field ) {
   ...
   */
  function rhswp_render_row_cb( $field_args, $field ) {
   ...
   * @param  CMB2_Field $field      The field object
   */
  function rhswp_display_text_small_column( $field_args, $field ) {
  	?>
   ...
   * @param  CMB2_Field object $field      Field object
   */
  function rhswp_before_row_if_2( $field_args, $field ) {
  ...
  function rhswp_register_demo_metabox() {
  	...
  	$cmb_demo = new_cmb2_box( array(
  		...
  		// 'show_on_cb' => 'rhswp_show_if_front_page', // function should return a bool value
  		// 'context'    => 'normal',
  		// 'priority'   => 'high',
  		...
  		// 'classes_cb' => 'rhswp_add_some_classes', // Add classes through a callback.
  	) );
  ...
  if ( 22 == 33 ) {
  	...
  	$cmb_demo->add_field( array(
  		...
  		'id'         => $prefix . 'text',
  		'type'       => 'text',
  		'show_on_cb' => 'rhswp_hide_if_no_cats', // function should return a bool value
    	...
    	$cmb_demo->add_field( array(
  		...
  		// );
  		// 'display_cb' => 'rhswp_display_text_small_column', // Output the display of the column values through a callback.
  	) );
    	...
    	$cmb_demo->add_field( array(
  		...
  		'type' => 'text',
  		'render_row_cb' => 'rhswp_render_row_cb',
  	) );
  	...
  	// ) );
    	...
    	$cmb_demo->add_field( array(
    		...
    		'type'         => 'text',
    		'before_row'   => 'rhswp_before_row_if_2', // callback
  ...
  function rhswp_register_dossier_actueel_page_metabox() {
  	...
  	$cmb_dossier_actueel_page = new_cmb2_box( array(
  		'id'           => $prefix . 'metabox',
  		'title'        => __( 'Bijbehorende tag / categorie', 'cmb2' ),
  		'description'        => __( 'Selecteer de tag / categorie van berichten die op deze pagina getoond moeten worden.', 'cmb2' ),
  		'object_types' => array( 'page', ), // Post type
  		'context'      => 'normal',
  		'priority'     => 'high',
  		'show_names'   => true, // Show field names on the left
//  		'show_on'      => array( 'id' => array( 2, 220 ) ), // Specific post IDs to display this metabox
      'show_on'      => array( 'key' => 'page-template', 'value' => 'page_dossiersingleactueel.php' ),
  ...
  if ( 22 == 33 ) {
    add_action( 'cmb2_admin_init', 'rhswp_register_repeatable_group_field_metabox' );
  }
  /**
   * Hook in and add a metabox to demonstrate repeatable grouped fields
   */
  function rhswp_register_repeatable_group_field_metabox() {
  	$prefix = 'rhswp_group_';
  ...
  if ( 22 == 33 ) {
    add_action( 'cmb2_admin_init', 'rhswp_register_user_profile_metabox' );
  }
  
  /**
   * Hook in and add a metabox to add fields to the user profile pages
   */
  function rhswp_register_user_profile_metabox() {
  	$prefix = 'rhswp_user_';
  ...
  if ( 22 == 33 ) {
    add_action( 'cmb2_admin_init', 'rhswp_register_taxonomy_metabox' );
  }

  /**
   * Hook in and add a metabox to add fields to taxonomy terms
   */
  function rhswp_register_taxonomy_metabox() {
  	$prefix = 'rhswp_term_';
  ...
  if ( 22 == 33 ) {
    add_action( 'cmb2_admin_init', 'rhswp_register_theme_options_metabox' );
  }
  
  /**
   * Hook in and register a metabox to handle a theme options page
   */
  function rhswp_register_theme_options_metabox() {
  
  	$option_key = 'rhswp_theme_options';
