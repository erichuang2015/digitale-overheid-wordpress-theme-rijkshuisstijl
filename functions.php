...
define( 'CHILD_THEME_VERSION',              "0.7.14" );
define( 'CHILD_THEME_VERSION_DESCRIPTION',  "Contentblock kan dossiers tonen. Extra check op taxonomy contentblock toegevoegd." );
